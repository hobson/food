...
ALLOWED_HOSTS = ['totalgood.com', 'storydecoder.com', 'www.totalgood.com', 'www.storydecoder.com', 'bit.storydecoder.com', 'localhost' , '192.168.0.3', '127.0.0.1', 'bm-desktop', 'bm.happyhouse.lcl', 'localhost.localdomain']
...
SECRET_KEY = env('TOTALGOOD_SECRET_KEY')
...
ROOT_URLCONF = 'totalgood.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'totalgood.wsgi.application'
