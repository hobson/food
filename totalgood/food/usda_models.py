...
class FoodDescription(models.Model):
    ...
    Long_Desc = models.CharField(max_length=200, blank=False,
         help_text="200-character description of food item.")
    Shrt_Desc = models.CharField(max_length=60, blank=False,
    ...
    ComName = models.CharField(max_length=100, blank=True,
    ...
    ManufacName = models.CharField(max_length=65, blank=True,
    ...
    Survey = models.CharField(max_length=1, blank=True,
         help_text="Indicates if the food item is used in the USDA Food and Nutrient Database for Dietary Studies (FNDDS) and thus has a complete nutrient profile for the 65 FNDDS nutrients.")
    Ref_desc = models.CharField(max_length=135, blank=True,
         help_text="Description of inedible parts of a food item (refuse), such as seeds or bone.")
    Refuse = models.FloatField(blank=True,
         help_text="Percentage of refuse.")
    SciName = models.CharField(max_length=65, blank=True,
         help_text="Scientific name of the food item. Given for the least processed form of the food (usually raw), if applicable.")
    N_Factor = models.FloatField(blank=True,
         help_text="Factor for converting nitrogen to protein (see p. 11).")
    Pro_Factor = models.FloatField(blank=True,
         help_text="Factor for calculating calories from protein (see p. 12).")
    Fat_Factor = models.FloatField(blank=True,
         help_text="Factor for calculating calories from fat (see p. 12).")
    CHO_Factor = models.FloatField(blank=True,
...
class FoodGroupDescription(models.Model):
...
class DataDerivationCodeDescription(models.Model):
...
class AbbreviatedData(models.Model):
